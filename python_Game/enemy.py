...
class Enemy(Entity):
    ...
    def get_player_distance_and_direction(self, player):
        ...
        distance = (player_vec - enemy_vec).magnitude()  # converting Vector into a distance
    ...
    def actions(self, player):
        if self.status == "attack":
            ...
            self.direction = self.get_player_distance_and_direction(player)[1]  # id 1 - direction
        else:
            self.direction = pygame.math.Vector2()  # enemy stops moving
