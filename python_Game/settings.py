...
UPGRADE_BG_COLOR_SELECTED = '#FFEBCD'
# weapon
...
monster_data = {
    ...
    "raccoon": {"health": 300, "exp": 250, "damage": 40, "attack_type": "claw",
                "attack_sound": "audio/attack/claw.wav", "speed": 3, "resistance": 1, "attack_radius": 150,
                "notice_radius": 400},
    "spirit": {"health": 100, "exp": 110, "damage": 8, "attack_type": "thunder",
               ...
               "notice_radius": 300},
    "bamboo": {"health": 100, "exp": 100, "damage": 20, "attack_type": "leaf_attack",
