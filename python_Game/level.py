...
class Level:
    ...
    def create_map(self):
        layouts = {
            "boundary": import_csv_layout("support_dict/map_FloorBlocks.csv"),
            "grass": import_csv_layout("support_dict/map_Grass.csv"),
            "object": import_csv_layout("support_dict/map_Objects.csv"),
            "entities": import_csv_layout("support_dict/map_Entities.csv")
        }
        graphics = {
    ...
    def run(self):
        # self.main_sound.play() something is wrong here idk
